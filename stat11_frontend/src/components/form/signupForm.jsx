...
} from "../genericComponent/genericFormFieldGenerators";
import { useDispatch } from "react-redux";
import { showSnackbar, signupUser } from "../../features/auth/authSlice";
import {
  changeSideBarTabsType,
  switchSideBarTab,
...
function SignupForm() {
  ...
  const continueToHomeClickHandler = () => {
    dispatch(switchSideBarTab("Home"));
    navigate("/home");
  };
  ...
  return (
    ...
    >
      ...
      >
        {checkBoxFormFieldGenerator(
          <Typography variant="body1" color="hint.dark">
            Are you a player?
          </Typography>,
          isPlayer,
          setIsPlayer
      ...
      >
        <Typography variant="h6" gutterBottom={true} color="hint.light">
